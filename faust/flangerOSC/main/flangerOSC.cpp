...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = FAUSTFLOAT(0.29999999999999999f);
		fVslider1 = FAUSTFLOAT(156.0f);
		fVslider2 = FAUSTFLOAT(0.5f);
		fVslider3 = FAUSTFLOAT(0.25f);
		fVslider4 = FAUSTFLOAT(0.94999999999999996f);
		fVslider5 = FAUSTFLOAT(0.20000000000000001f);
		fVslider6 = FAUSTFLOAT(0.80000000000000004f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openHorizontalBox("Echo flanger");
		...
		ui_interface->declare(&fVslider3, "04", "");
		ui_interface->addVerticalSlider("Rate", &fVslider3, 0.25f, 0.0f, 3.0f, 0.00999999978f);
		ui_interface->declare(&fVslider2, "05", "");
		ui_interface->addVerticalSlider("Width", &fVslider2, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fVslider4, "06", "");
		ui_interface->addVerticalSlider("Depth", &fVslider4, 0.949999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->declare(&fVslider5, "08", "");
		ui_interface->addVerticalSlider("EchoDelay", &fVslider5, 0.200000003f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fVslider6, "09", "");
		ui_interface->addVerticalSlider("EchoLvl", &fVslider6, 0.800000012f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fVslider0, "10", "");
		ui_interface->addVerticalSlider("EchoFbk", &fVslider0, 0.300000012f, 0.0f, 0.970000029f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow5 = (0.000500000024f * float(fVslider5));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = (fRec5[1] + (fConst1 * fRec6[1]));
			fRec5[0] = (fTemp1 - std::floor(fTemp1));
			float fTemp2 = (fRec3[0] * ((0.5f * (fRec4[0] * ((2.0f * (1.0f - std::fabs(((2.0f * fRec5[0]) + -1.0f)))) + -1.0f))) + 1.0f));
			int iTemp3 = int(fTemp2);
			float fTemp4 = std::floor(fTemp2);
			float fRec2 = (0.0f - ((fRec0[((IOTA - (std::min<int>(513, std::max<int>(0, iTemp3)) + 1)) & 1023)] * (fTemp4 + (1.0f - fTemp2))) + ((fTemp2 - fTemp4) * fRec0[((IOTA - (std::min<int>(513, std::max<int>(0, (iTemp3 + 1))) + 1)) & 1023)])));
			fRec7[0] = (fSlow4 + (0.999000013f * fRec7[1]));
			fVec0[(IOTA & 262143)] = (fTemp0 + (0.5f * (fRec1[0] * (fRec0[((IOTA - 1) & 1023)] - (fRec2 * fRec7[0])))));
			fRec8[0] = (fSlow5 + (0.999499977f * fRec8[1]));
			float fTemp5 = fVec0[((IOTA - int(std::min<float>(fConst0, std::max<float>(0.0f, (fConst0 * fRec8[0]))))) & 262143)];
			fVec1[(IOTA & 1023)] = fTemp5;
			float fTemp6 = ((fConst2 * fRec6[1]) + fRec10[1]);
			fRec10[0] = (fTemp6 - std::floor(fTemp6));
			float fTemp7 = (fRec3[0] * ((0.5f * (fRec4[0] * ((2.0f * (1.0f - std::fabs(((2.0f * fRec10[0]) + -1.0f)))) + -1.0f))) + 1.0f));
			int iTemp8 = int(fTemp7);
			float fTemp9 = std::floor(fTemp7);
			float fRec9 = (0.0f - ((fVec1[((IOTA - std::min<int>(513, std::max<int>(0, iTemp8))) & 1023)] * (fTemp9 + (1.0f - fTemp7))) + ((fTemp7 - fTemp9) * fVec1[((IOTA - std::min<int>(513, std::max<int>(0, (iTemp8 + 1)))) & 1023)])));
			fRec0[(IOTA & 1023)] = (0.5f * (fTemp5 - (fRec7[0] * fRec9)));
			fRec11[0] = (fSlow6 + (0.999000013f * fRec11[1]));
			float fTemp10 = (fTemp0 + (fRec0[((IOTA - 0) & 1023)] * fRec11[0]));
...
flangerOSC::flangerOSC(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void flangerOSC::setParamValue(const std::string& path, float value)
{
...
extern "C" void app_main()
{
    ...
    flangerOSC* DSP = new flangerOSC(48000, 32);
    DSP->start();
