...
/* ------------------------------------------------------------
name: "basicFlanger"
Code generated with Faust 2.23.3 (https://faust.grame.fr)
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "basicFlanger.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst1 = (int(std::min<float>((2.61999989f * fConst0), std::max<float>(0.0f, (0.319999993f * fConst0)))) + 1);
		fConst2 = (1.0f / fConst0);
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.20000000000000001f);
		fHslider1 = FAUSTFLOAT(156.0f);
		fHslider2 = FAUSTFLOAT(0.5f);
		fHslider3 = FAUSTFLOAT(0.25f);
		fHslider4 = FAUSTFLOAT(0.94999999999999996f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Delay", &fHslider1, 156.0f, 5.0f, 1000.0f, 1.0f);
		ui_interface->declare(&fHslider0, "4", "");
		ui_interface->addHorizontalSlider("Flange Fb", &fHslider0, 0.200000003f, 0.0f, 0.970000029f, 0.00999999978f);
		ui_interface->declare(&fHslider4, "5", "");
		ui_interface->addHorizontalSlider("Flange Dep", &fHslider4, 0.949999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider3, "6", "");
		ui_interface->addHorizontalSlider("Rate", &fHslider3, 0.25f, 0.0f, 3.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = ((fRec10[0] * fRec9[1]) - fTemp0);
			...
			float fTemp2 = (fRec13[1] + (fConst2 * fRec14[1]));
			fRec13[0] = (fTemp2 - std::floor(fTemp2));
			float fTemp3 = (0.5f * (fRec12[0] * ((2.0f * (1.0f - std::fabs(((2.0f * fRec13[0]) + -1.0f)))) + -1.0f)));
			float fTemp4 = (fRec11[0] * (fTemp3 + 1.0f));
			int iTemp5 = int(fTemp4);
			float fTemp6 = std::floor(fTemp4);
			fRec9[0] = ((fVec0[((IOTA - std::min<int>(513, std::max<int>(0, iTemp5))) & 1023)] * (fTemp6 + (1.0f - fTemp4))) + ((fTemp4 - fTemp6) * fVec0[((IOTA - std::min<int>(513, std::max<int>(0, (iTemp5 + 1)))) & 1023)]));
			fRec15[0] = (fSlow4 + (0.999000013f * fRec15[1]));
			fRec8[(IOTA & 65535)] = ((0.479999989f * fRec8[((IOTA - iConst1) & 65535)]) + (0.5f * (fTemp0 - (fRec9[0] * fRec15[0]))));
			float fTemp7 = fRec8[((IOTA - 0) & 65535)];
			float fTemp8 = ((fRec10[0] * fRec16[1]) - fTemp7);
			fVec1[(IOTA & 1023)] = fTemp8;
			float fTemp9 = (fRec11[0] * (1.0f - fTemp3));
			int iTemp10 = int(fTemp9);
			float fTemp11 = std::floor(fTemp9);
			fRec16[0] = ((fVec1[((IOTA - std::min<int>(513, std::max<int>(0, iTemp10))) & 1023)] * (fTemp11 + (1.0f - fTemp9))) + ((fTemp9 - fTemp11) * fVec1[((IOTA - std::min<int>(513, std::max<int>(0, (iTemp10 + 1)))) & 1023)]));
			float fTemp12 = ((0.699999988f * fRec6[1]) + (0.0299999993f * (fTemp7 - (fRec15[0] * fRec16[0]))));
			fVec2[(IOTA & 511)] = fTemp12;
			fRec6[0] = fVec2[((IOTA - 346) & 511)];
			float fRec7 = (0.0f - (0.699999988f * fTemp12));
			float fTemp13 = (fRec6[1] + (fRec7 + (0.699999988f * fRec4[1])));
			fVec3[(IOTA & 127)] = fTemp13;
			fRec4[0] = fVec3[((IOTA - 112) & 127)];
			float fRec5 = (0.0f - (0.699999988f * fTemp13));
			float fTemp14 = (fRec4[1] + (fRec5 + (0.699999988f * fRec2[1])));
			fVec4[(IOTA & 63)] = fTemp14;
			fRec2[0] = fVec4[((IOTA - 36) & 63)];
			float fRec3 = (0.0f - (0.699999988f * fTemp14));
			float fTemp15 = (fRec3 + fRec2[1]);
			float fTemp16 = (fTemp15 + (0.773000002f * fRec0[1]));
			fVec5[(IOTA & 2047)] = fTemp16;
			fRec0[0] = fVec5[((IOTA - 1866) & 2047)];
			fRec1[0] = fTemp16;
			float fTemp17 = (fTemp15 + (0.73299998f * fRec17[1]));
			fVec6[(IOTA & 4095)] = fTemp17;
			fRec17[0] = fVec6[((IOTA - 2250) & 4095)];
			fRec18[0] = fTemp17;
			output0[i] = FAUSTFLOAT(((2.0f * fRec1[1]) + (2.0f * fRec18[1])));
			float fTemp18 = (fRec2[1] + (fRec3 + (0.801999986f * fRec19[1])));
			fVec7[(IOTA & 2047)] = fTemp18;
			fRec19[0] = fVec7[((IOTA - 1600) & 2047)];
			fRec20[0] = fTemp18;
			float fTemp19 = (fTemp15 + (0.753000021f * fRec21[1]));
			fVec8[(IOTA & 4095)] = fTemp19;
			fRec21[0] = fVec8[((IOTA - 2052) & 4095)];
			fRec22[0] = fTemp19;
			output1[i] = FAUSTFLOAT((0.0f - ((((fRec20[1] + fRec1[1]) + fRec22[1]) + fRec18[1]) + ((fRec1[1] + fRec18[1]) - (fRec20[1] + fRec22[1])))));
			fRec10[1] = fRec10[0];
			IOTA = (IOTA + 1);
			fRec11[1] = fRec11[0];
			fRec12[1] = fRec12[0];
...
basicFlanger::basicFlanger(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void basicFlanger::setParamValue(const std::string& path, float value)
{
...
extern "C" void app_main()
{
    ...
    basicFlanger* DSP = new basicFlanger(48000, 32);
    DSP->start();
