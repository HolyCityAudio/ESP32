...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::tan((97.3893738f / fConst0));
		...
		fConst9 = (0.0f - fConst5);
		fConst10 = ((1.0f - fConst3) / fConst4);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec3[0] = (fConst7 * ((0.0270000007f * (fRec2[1] + fRec2[2])) - (fConst8 * fRec3[1])));
			float fTemp0 = (200.0f * (((float(input0[i]) + float(input1[i])) + fRec3[0]) + 3.41834402f));
			...
			fRec2[0] = (((ftbl0mydspSIG0[int(fTemp1)] * (1.0f - fTemp2)) + (fTemp2 * ftbl0mydspSIG0[int((fTemp1 + 1.0f))])) + -191.420151f);
			fRec1[0] = ((0.0250000004f * ((fConst5 * fRec2[0]) + (fConst9 * fRec2[1]))) - (fConst10 * fRec1[1]));
			fRec5[0] = (fSlow0 + (0.999000013f * fRec5[1]));
			float fTemp3 = ((fRec5[0] * fRec4[1]) - fRec1[0]);
			fVec0[(IOTA & 1023)] = fTemp3;
			fRec6[0] = (fSlow1 + (0.999000013f * fRec6[1]));
			fRec7[0] = (fSlow2 + (0.999000013f * fRec7[1]));
			fRec9[0] = (fSlow3 + (0.999000013f * fRec9[1]));
			float fTemp4 = (fRec8[1] + (fConst11 * fRec9[1]));
			fRec8[0] = (fTemp4 - std::floor(fTemp4));
			float fTemp5 = (0.5f * (fRec7[0] * ((2.0f * (1.0f - std::fabs(((2.0f * fRec8[0]) + -1.0f)))) + -1.0f)));
			float fTemp6 = (fRec6[0] * (fTemp5 + 1.0f));
			int iTemp7 = int(fTemp6);
			float fTemp8 = std::floor(fTemp6);
			fRec4[0] = ((fVec0[((IOTA - std::min<int>(513, std::max<int>(0, iTemp7))) & 1023)] * (fTemp8 + (1.0f - fTemp6))) + ((fTemp6 - fTemp8) * fVec0[((IOTA - std::min<int>(513, std::max<int>(0, (iTemp7 + 1)))) & 1023)]));
			fRec10[0] = (fSlow4 + (0.999000013f * fRec10[1]));
			fRec0[(IOTA & 65535)] = ((0.180000007f * fRec0[((IOTA - iConst1) & 65535)]) + (0.5f * (fRec1[0] - (fRec4[0] * fRec10[0]))));
			float fTemp9 = fRec0[((IOTA - 0) & 65535)];
			float fTemp10 = ((fRec5[0] * fRec11[1]) - fTemp9);
			fVec1[(IOTA & 1023)] = fTemp10;
			float fTemp11 = (fRec6[0] * (1.0f - fTemp5));
			int iTemp12 = int(fTemp11);
			float fTemp13 = std::floor(fTemp11);
			fRec11[0] = ((fVec1[((IOTA - std::min<int>(513, std::max<int>(0, iTemp12))) & 1023)] * (fTemp13 + (1.0f - fTemp11))) + ((fTemp11 - fTemp13) * fVec1[((IOTA - std::min<int>(513, std::max<int>(0, (iTemp12 + 1)))) & 1023)]));
			float fTemp14 = (0.5f * (fTemp9 - (fRec10[0] * fRec11[0])));
